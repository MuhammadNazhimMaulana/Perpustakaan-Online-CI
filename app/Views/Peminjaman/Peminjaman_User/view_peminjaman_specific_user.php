...
<div class="container mb-5 my-3 py-5">
    <div class="col-md-12">
        <div class="row latar" id="bookmain">
                ...
                <div id="carousel-slide" class="carousel slide mt-3" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="<?= base_url('upload/Buku/' . $peminjaman->foto_buku) ?>" class="d-block w-100">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="box-back">
                    <h1 class="text-center mt-3"><?= $peminjaman->nama_buku ?></h1>
                    <hr class="gelap">
                    <div class="book-information">
                        <a href="<?= base_url('user/borrow') ?>" class="back">Kembali ke Daftar</a>
                        <div class="mb-3 row mt-3">
                            <label for="Peminjam" class="col-sm-2 col-form-label">Nama Peminjam</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="Peminjam" readonly value="<?= $peminjaman->nama_user ?>">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="Editor" class="col-sm-2 col-form-label">Tanggal Pinjam</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="Editor" readonly value="<?= $peminjaman->tanggal_peminjaman ?>">
                            </div>
                        </div>
                        <p class="description">
                        ...
                        <a href="<?= base_url('user/borrow/pdf/' . $peminjaman->id_peminjaman) ?>" class="btn btn-primary">Pdf</a>
                    </div>
                </div>
            </div>
        </div>
